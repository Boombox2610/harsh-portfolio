    ...
    <>
      ...
      <div className="l3__window-content" style={{ maxHeight: 420 }}>
        ...
        <div className="l3__award-grid">
          <a href="https://www.linkedin.com/posts/harsh-maru2610_hackathon-disabilityinclusion-innovation-ugcPost-7438912229619478528-iW6h/?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEU_Gm8BG2LbLid22qEdZryjVdlNEk73kLo" target="_blank" rel="noopener noreferrer" className="l3__award-card"><strong>🥉 NMIMS Tech Hackathon on Disability - 2026</strong>3rd Place — GestoChair (Multi-modal wheelchair retrofit platform)</a>
          <a href="https://www.linkedin.com/in/harsh-maru2610/" target="_blank" rel="noopener noreferrer" className="l3__award-card"><strong>🥇 NMIMS Polarizer Project Competition 2024</strong>1st Place — QuadStreamCV (Custom drone + ROS pose detection)</a>
          <a href="https://www.linkedin.com/in/harsh-maru2610/" target="_blank" rel="noopener noreferrer" className="l3__award-card"><strong>🥇 IEEE Research Paper TechSafar TechSkript'25</strong>1st Place — GestoDrive (Hand gesture game controller, IEEE published)</a>
