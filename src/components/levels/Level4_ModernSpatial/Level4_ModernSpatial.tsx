...
const BracketCursor: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="l4__cursor-corner l4__cursor-corner--tl" />
      <div className="l4__cursor-corner l4__cursor-corner--tr" />
      <div className="l4__cursor-corner l4__cursor-corner--bl" />
      <div className="l4__cursor-corner l4__cursor-corner--br" />
    </motion.div>
  );
};
  ...
  return (
    <div ref={ref} className="l4__hero">
      <motion.div style={{ y, opacity }} className="l4__hero">
        <div className="l4__hero-overline">portfolio — 2023 / 2026</div>
